...
* Tìm hiểu AWS và khởi tạo hạ tầng dự án (VPC, S3, C# Monorepo).
...
* Thiết lập thành công hạ tầng mạng và lưu trữ cơ bản trên AWS.
* Hoàn thành bộ khung mã nguồn C# Monorepo dùng chung cho Backend và Frontend.
* Nắm vững cách cấu hình và bảo mật tài khoản AWS.
